    ...
    <div class="preview-form" v-if="visible">
        <div class="final-preview">
            <div class="final-preview-inner">
                <div class="preview-title">{{ pageState.title }}</div>
        ...
        <a-drawer title="设置面板" placement="right" width="400" :closable="true" :visible="visible" @close="onCancel">
            <div class="publish-form-container">
                ...
                <a-row type="flex" align="middle" :style="{ marginBottom: '20px' }">
                    ...
                    <a-col :span="10">
                        <styled-uploader text="上传封面" @success="updateAvatar" :uploaded="form.uploaded" showUploaded>
                        </styled-uploader>
                    </a-col>
                </a-row>
                <a-form :label-col="{ span: 6 }" :wrapper-col="{ span: 16 }" :model="form" :rules="rules">
